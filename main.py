...
# --------------------------------------------
# Nueva función: Obtener solo partidos EN VIVO desde SofaScore
# --------------------------------------------
    ...
    for league in LEAGUES:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Buscar solo partidos con clase 'event__match--live' o 'event__live'
                live_matches = soup.find_all("a", class_="event__match--live")
                if not live_matches:
                    live_matches = soup.find_all("a", class_="event__live")
...
# --------------------------------------------
# Obtener partidos del día (sin cambios)
# --------------------------------------------
...
# --------------------------------------------
# Extraer marcador actual (sin cambios)
# --------------------------------------------
...
# --------------------------------------------
# Extraer eventos en vivo de un partido (sin cambios)
# --------------------------------------------
...
# --------------------------------------------
# Enviar resumen diario de partidos (sin cambios)
# --------------------------------------------
def daily_summary():
...
def monitor_live_matches():
    matches = get_live_matches()  # Cambio aquí para usar solo partidos EN VIVO
    if not matches:
